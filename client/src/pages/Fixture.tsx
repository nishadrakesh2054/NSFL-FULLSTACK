...
//     {
//       id: 5,
//       homeTeam: "Royal Knights FC",
//       homeTeamLogo: "/image/img-01.png",
//       awayTeam: "Phoenix United",
//       awayTeamLogo: "/image/7-98x98.png",
//       date: new Date().toISOString().split("T")[0],
//       time: "20:00",
//       venue: "Knight's Arena",
//       status: "upcoming",
//     },
//     {
//       id: 6,
//       homeTeam: "Storm Riders FC",
//       homeTeamLogo: "/image/8-98x98.png",
...
//           <div className="bg-gray-100 rounded-lg p-1 inline-flex flex-wrap justify-center gap-2">
//             <button
...
//             >
//               <FaFutbol className="mr-2" /> All Fixtures
//             </button>
//             <button
//               className={`px-6 py-2 rounded-md text-sm font-medium transition-colors flex items-center ${
//                 activeTab === "today"
...
//             >
//               <FaCalendarAlt className="mr-2" /> Today's Matches
//             </button>
//             <button
//               className={`px-6 py-2 rounded-md text-sm font-medium transition-colors flex items-center ${
//                 activeTab === "upcoming"
...
//             >
//               <FaClock className="mr-2" /> Upcoming Fixtures
//             </button>
//             <button
//               className={`px-6 py-2 rounded-md text-sm font-medium transition-colors flex items-center ${
//                 activeTab === "completed"
