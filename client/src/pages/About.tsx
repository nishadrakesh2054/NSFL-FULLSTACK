...
import { FaShieldAlt, FaHeart, FaLightbulb, FaHandsHelping, FaStar } from 'react-icons/fa';
  ...
  return (
    <>
      ...
      <div 
        ...
        style={{ backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.7)), url('/image/about.jpeg')" }}
      >
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">About NSFL</h1>
  ...
  <div className="container mx-auto px-4 relative z-10">
    <div className="max-w-4xl mx-auto text-center">
      ...
      <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
        Welcome to the <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-800">National Soccer Football League</span>
      </h2>
      <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto">
        The NSFL is the premier professional soccer league, bringing together the most talented players and passionate fans across the nation. We're committed to excellence both on and off the pitch.
      </p>
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
      {[
        { icon: <FaFutbol className="text-4xl"/>, value: "12", label: "Teams" },
        { icon: <FaTrophy className="text-4xl"/>, value: "14", label: "Seasons" },
        { icon: <FaUsers className="text-4xl"/>, value: "2M+", label: "Fans" },
        { icon: <FaFlag className="text-4xl"/>, value: "6", label: "Championships" }
      ].map((item, index) => (
        <div 
          key={index}
        ...
        >
          ...
          <h3 className="text-3xl font-bold text-gray-900 mb-2 text-center">{item.value}</h3>
          <p className="text-gray-500 font-medium text-center">{item.label}</p>
        </div>
      ))}
    </div>
  </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
      ...
      <div className="bg-white/90 backdrop-blur-sm p-10 rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-500 border border-white/20">
        ...
        <p className="text-lg text-gray-700 mb-6">
          To promote the growth of soccer by providing world-class entertainment, developing elite athletes, and fostering community engagement through the beautiful game.
        </p>
      ...
      <div className="bg-white/90 backdrop-blur-sm p-10 rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-500 border border-white/20">
        ...
        <p className="text-lg text-gray-700 mb-6">
          To become the most respected and competitive soccer league globally, recognized for our sportsmanship, innovation, and positive impact on communities.
        </p>
        <ul className="space-y-3">
          {[
  ...
  <div className="container mx-auto px-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {[
        { 
          title: "Integrity", 
          description: "We uphold the highest standards of fairness, ethics, and sportsmanship.",
          icon: <FaShieldAlt className="text-2xl text-red-600" />
        },
        { 
          title: "Passion", 
          description: "We play and operate with heart, energy, and enthusiasm that inspires our fans.",
          icon: <FaHeart className="text-2xl text-red-600" />
        },
        { 
          title: "Innovation", 
          description: "We constantly evolve to enhance the game experience through technology.",
          icon: <FaLightbulb className="text-2xl text-red-600" />
        },
        { 
          title: "Community", 
          description: "We believe in giving back and using soccer as a force for positive change.",
